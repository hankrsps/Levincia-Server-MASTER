                ...
                .setWalkToTask(new WalkToTask(player, position, gameObject.getSize(), new FinalizedMovementTask() {
                    ...
                    public void execute() {
                        ...
                        switch (id) {
                            ...
                            case 11394: // Whispering Tree object ID
                                Mining.listenAfkTree(player, 11394, 1); // You can pass different tiers if needed
                                break;

                            case 26121: // Magical hive object ID
                                Mining.tendAfkBeehive(player);
                                break;
                            case 2153: // SoulPyre
