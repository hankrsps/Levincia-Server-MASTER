        ...
        switch (itemId) {
           ...
           /* case 23488:
            ...
            case 8851:
                ...
                player.sendMessage("You just exchanged 1k tokens into Levincia tokens.");
                break;
            case 23446:
            ...
            case 23020:
                ...
                player.getPacketSender()
                        .sendMessage("@blu@You are rewarded " + (amt * 1) + " vote "
                                + (amt > 1 ? "points, " : "point, ") + (5_000 * amt) + " Levincia tokens");
                player.getPacketSender()
    ...
    public void secondAction(Player player, Packet packet) {
        ...
        switch (itemId) {
            ...
            case 12855:
                ...
                player.sendMessage("You just exchanged Levincia tokens into 1k tokens.");
                break;
           ...
           /* case 15330:
                if (player.getInventory().contains(15330) &&
                    ...
                    player.sendMessage("You need 50m Levincia tokens to upgrade.");
                }
                break;*/
            case 22108:
           ...
           /* case 19000:
                if (player.getInventory().contains(19000)) {
                    ...
                    player.sendMessage("You have exchanged X" + amount + " Pet fragments for X" + amount * 100 + " Levincia tokens!");
                }
                break;*/
