...
public class EnterAmountToRisk extends EnterAmount {
    ...
    public void handleAmount(Player player, int amount) {
        ...
        player.setSoulRiskAmount(amount);
        player.setDialogueActionId(5555); // You handle this case in DialogueActions
        ...
        DialogueManager.start(player, new Dialogue() {
            ...
            public String[] dialogue() {
                return new String[] {
                        "Are you sure you want to risk " + amount + " souls?"
                };
