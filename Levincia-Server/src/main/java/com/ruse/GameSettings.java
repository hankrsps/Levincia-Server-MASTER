...
public class GameSettings {
    ...
    public static final String RSPS_NAME = "Levincia";
    /**
     * WEB URLS
     */
    public static final String DomainUrl = "https://levincia.io/";
    public static final String ForumUrl = "https://levincia.io/forums";
    public static final String UpdateUrl = "https://discord.com/invite/EWbMsxdm78";
    public static final String StoreUrl = "https://levincia.io/store/index.php";
    ...
    public static final String VoteUrl = "https://www.levincia.io/vote";
    public static final String PriceList = "https://discord.com/invite/EWbMsxdm78";
    public static final String HiscoreUrl = "https://www.levincia.io/store";
    ...
    public static boolean FridayThe13th = true;
