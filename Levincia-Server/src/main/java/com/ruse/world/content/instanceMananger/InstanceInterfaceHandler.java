...
public class InstanceInterfaceHandler {
    ...
    public void sendInfo() {
        ...
        player.getPacketSender().sendString(35010, "Spawns: @whi@" + (player.getInstanceManager().ticketID == 23264 ? 300 : 150));
        player.getPacketSender().sendString(35011, "Cost: @whi@" + Misc.sendCashToString(player.getInstanceManager().getCost()) + " Levincia tokens");
