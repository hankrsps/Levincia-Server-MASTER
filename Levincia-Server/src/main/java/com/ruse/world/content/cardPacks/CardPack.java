...
public class CardPack {
    ...
    public static CardPackReward[] loot = { //
            ...
            new CardPackReward(22950, 1, LEGENDARY), // Fantasy Attachment
            new CardPackReward(22110, 1, LEGENDARY), // Owner's Attachment
            new CardPackReward(22109, 1, LEGENDARY), // Owner's cape (u)
            new CardPackReward(23253, 2, LEGENDARY), // Zenyte Casket
            new CardPackReward(13289, 1, LEGENDARY), // Elidinis's Ward
            new CardPackReward(22117, 1, LEGENDARY), // Zenyte Shield
            ...
            new CardPackReward(23226, 1, LEGENDARY), // Blood Twisted bow
            new CardPackReward(8136, 1, LEGENDARY), // Blood Sanguinesti Staff
            new CardPackReward(23383, 1,LEGENDARY), // Lesarkus Blade
    };
}
