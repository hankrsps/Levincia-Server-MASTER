	...
	public void handleAll(int id) {
		for(DissolvingData data : DissolvingData.values()) {
			if(data.getId() == id) {
				...
				player.getPacketSender().sendMessage("You dissolved " + ItemDefinition.forId(id).getName() +" for " + Misc.insertCommasToNumber(data.getrewardamt() * player.getInventory().getAmount(data.getId())) +" Levincia tokens" );
