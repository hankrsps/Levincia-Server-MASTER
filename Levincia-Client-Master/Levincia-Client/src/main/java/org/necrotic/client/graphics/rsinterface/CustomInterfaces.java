...
public class CustomInterfaces extends RSInterface {
	...
	public static void drawFilledBar(int bgId, int progressBarId, int width, int height, int max, int textId, int currentPercent, int firstColor, int secondColor, TextDrawingArea[] tda) {
		addSpriteLoader(bgId, 1684); // red empty background
		new ProgressBar(progressBarId, width, height, new int[]{firstColor}, true, false, "", new int[]{secondColor});
		addText(textId, "", tda, 1, 0xFFFFFF, true, true);
	}


	public static void soulPyreInterface(TextDrawingArea[] tda) {
		RSInterface rsi = addInterface(143500);

		addSpriteLoader(143501, 1811); // Full background
		addText(143502, "SoulPyre Offering", tda, 2, 0xFF5500, true, true);

		// Boss Progress Bar
		drawFilledBar(143503, 143504, 161, 22, 500000, 143505, 0, 0x66CCFF, 0x331C64, tda);

		// Key Progress Bar - dark gray background, red fill
		drawFilledBar(143506, 143507, 161, 22, 350000, 143508, 0, 0x00E676, 0x1B2F1A, tda);

//0xA9A9A9
		// Offer Soul Button
		addHoverButtonWSpriteLoader(143509, 1889, 118, 28, "Offer Souls", -1, 143510, 1);
		addHoveredImageWSpriteLoader(143510, 1890, 118, 28, 143511);

		addText(143512, "Aetheron, the Bound Flame", tda, 1, 0xff981f, true, true);
		addText(143513, "Fill the progress bar to spawn Aetheron", tda, 3, 0xFFFFFF, true, true);

		addText(143514, "Sealed Urn of Whispers", tda, 1, 0xff981f, true, true);
		addText(143515, "Fill the progress bar to obtain the Sealed Urn of Whispers", tda, 3, 0xFFFFFF, true, true);
		addText(143516, "Offer Souls at the SoulPyre, Fill the progress bars\\n and spawn Aetheron, or unlock exclusive rewards.\\n Risk your Souls for a chance to double them. (ITEM RISK 55x2)", tda, 1, 0xff981f, true, true);


		// Offer Soul Button
		addHoverButtonWSpriteLoader(143517, 1889, 118, 28, "Risk Souls (55x2 Roll)", -1, 143518, 1);
		addHoveredImageWSpriteLoader(143518, 1890, 118, 28, 143519);

		addText(143521, "Offer Souls", tda, 2, 0xFF5500, true, true);
		addText(143522, "Risk Souls (55x2)", tda, 2, 0xFF5500, true, true);


		int x = 50;
		int y = 45;
		addHoverButtonWSpriteLoader(143525, 1016, 16, 16, "Close Window", 0, 143525 + 1, 3);
		addHoveredImageWSpriteLoader(143526, 1017, 16, 16, 143526 + 1);


		setChildren(21, rsi);
		setBounds(143501, 45, 20, 0, rsi);     // Background
		setBounds(143502, 260, 23, 1, rsi);     // Title
		setBounds(143503, 180, 150, 2, rsi);   // Boss bar background
		setBounds(143504, 180, 150, 3, rsi);   // Boss bar fill
		setBounds(143505, 260, 152, 4, rsi);   // Boss % text
		setBounds(143506, 180, 190, 5, rsi);   // Key bar background
		setBounds(143507, 180, 225, 6, rsi);   // Key bar fill
		setBounds(143508, 260, 227, 7, rsi);   // Key % text
		setBounds(143509, 295, 258, 8, rsi);   // Button
		setBounds(143510, 295, 258, 9, rsi);   // Hovered button
		setBounds(143517, 105, 258, 15, rsi);   // Button2
		setBounds(143518, 105, 258, 16, rsi);   // Hovered button2
		setBounds(143512, 260, 108, 10, rsi);   // Title1
		setBounds(143513, 260, 120, 11, rsi);   // description1
		setBounds(143514, 260, 180, 12, rsi);   // Title2
		setBounds(143515, 260, 195, 13, rsi);   // description2
		setBounds(143516, 260, 58, 14, rsi);   // bio
		setBounds(143522, 163, 265, 17, rsi);   // button text
		setBounds(143521, 355, 265, 18, rsi);   // button text
		setBounds(143525, 387 + x, 23,19,rsi);
		setBounds(143526, 387 + x, 23,20,rsi);
	...
	private static void dailyTaskInterface() {
		...
		addText(143002, "Levincia's Daily Tasks", tda, 2, 0xff981f, true, true);
	...
	public static void instanceManager() {
		...
		addText(id, "Cost: 5k Levincia tokens", tda, 1, 0xff8624, true, true);
...
//        RSInterface.drawNpcOnInterface(id, 100, 1000);
	...
	public static void grandLottery(TextDrawingArea[] TDA) {
		...
		addText(30906, "Levincia Grand Lottery", TDA, 2, 0xFF981F, true, true);
	...
	public static void upgradeInterface(TextDrawingArea[] tda) {
		...
		RSInterface.addText(62211, "How to get Levincia tokens?", tda, 1, 0xFFA500);
		...
		RSInterface.addText(62233, "Levincia tokens are obtained from dissolving extra items, PvM drops.", tda, 0, 0xe6e5e6);
	...
	public static void leaderboardInterface() {
		...
		addText(id, "Levincia's Leaderboard", tda, 2, 16750643, true, true);
	...
	public void discordConnect() {
		...
		addText(19135, "- Receive free Donator rank for linking"
				...
				+ "\\nHaving \"Levincia\" in your custom status", tda, 0, 0xf0aa37, true, true);


		addToggleButton(19137, 1337, 3244, 15, 15, "Auto Retaliate");

		addText(19138, "Recieve message when Levincia updates", tda, 0, 0xf0aa37, true, true);
	...
	private void playerPanel() {
		...
		addText(39155, "Levincia", tda, 0, ColorConstants.AQUA, false, true);
...
/*	   addHoverButtonWSpriteLoader(11004, 707, 18, 18, "Select", -1, 11005, 1);
	...
	static void godsInterface() {
		...
		addText(id, "100k Levincia tokens", tda, 1, 0xFFFFFF, true, true);
